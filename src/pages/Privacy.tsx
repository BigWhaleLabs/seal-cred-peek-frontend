import { BodyText, Link, SectionSubheader } from 'components/Text'
...
export default function () {
  return (
    <div className={space('space-y-4')}>
      <PageTitle backButton title="Privacy Policy" />
      <div className={space('space-y-4')}>
        <Section>
          <BodyText>
          ...
          <BodyText>
            ...
            anyone decided to use our Service, the website.
          </BodyText>
          <BodyText>
        ...
        <Section>
          <SectionSubheader>Information Collection and Use</SectionSubheader>
          <BodyText>
        ...
        <Section>
          <SectionSubheader>Log Data</SectionSubheader>
          <BodyText>
        ...
        <Section>
          <SectionSubheader>Cookies</SectionSubheader>
          <BodyText>
        ...
        <Section>
          <SectionSubheader>Service Providers</SectionSubheader>
          <BodyText>
        ...
        <Section>
          <SectionSubheader>Security</SectionSubheader>
          <BodyText>
        ...
        <Section>
          <SectionSubheader>Links to Other Sites</SectionSubheader>
          <BodyText>
        ...
        <Section>
          <SectionSubheader>Children’s Privacy</SectionSubheader>
          <BodyText>
        ...
        <Section>
          <SectionSubheader>Changes to This Privacy Policy</SectionSubheader>
          <BodyText>
        ...
        <Section>
          ...
          <BodyText>
            ...
            <Link url="mailto:request@bwl.gg?subject=Request removing information">
              request@bwl.gg
            </Link>
            .
          </BodyText>
        ...
        <Section>
          <SectionSubheader>Contact Us</SectionSubheader>
          <BodyText>
            If you have any questions or suggestions about our Privacy Policy,
            do not hesitate to contact us at{' '}
            <Link url="mailto:privacy@bwl.gg?subject=Privacy Policy question">
              privacy@bwl.gg
            </Link>
            .
          </BodyText>
